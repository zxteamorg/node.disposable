...
describe("Initable tests", function () {
	...
	interface TestInitable extends InitableMixin {}
	InitableMixin.applyMixin(TestInitable);
	...
	it("Should throw error from init()", async function () {
		class MyInitable implements Initable {
		...
		interface MyInitable extends InitableMixin {}
		InitableMixin.applyMixin(MyInitable);
